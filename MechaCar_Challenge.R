...
# 5. Perform linear regression using the lm() function. In the lm() function, pass 
...
# 1. In your MechaCarChallenge.RScript, write an RScript using the t.test() function 
